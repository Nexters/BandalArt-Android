 ...
 * BottomSheetUiState
 *
 * @param bandalartData 반다라트 표의 데이터
 * @param initialCellData 반다라트 표의 변경 완료 버튼 활성화를 위한 반다라트 의 초기 데이터
 * @param cellData 반다라트 표의 현재 선택된 셀의 데이터
 * @param initialCellData 반다라트 표의 변경 완료 버튼 활성화를 위한 Cell 의 초기 데이터
