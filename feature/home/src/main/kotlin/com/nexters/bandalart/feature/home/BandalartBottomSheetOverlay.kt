...
sealed interface BandalartBottomSheetResult {
    data object Dismiss : BandalartBottomSheetResult
    data class OnCompleteButtonClick(
        val bandalartId: Long,
        val cellId: Long,
        val cellType: CellType,
    ) : BandalartBottomSheetResult

    data object OnDeleteButtonClick : BandalartBottomSheetResult
    data class OnDeleteDialogConfirmClick(val id: Long) : BandalartBottomSheetResult
    data object OnDeleteDialogCancelClick : BandalartBottomSheetResult
    data object OnDatePickerClick : BandalartBottomSheetResult
    data object OnEmojiPickerClick : BandalartBottomSheetResult
    data class OnEmojiSelect(val emoji: String) : BandalartBottomSheetResult
    data class OnColorSelect(val mainColor: String, val subColor: String) : BandalartBottomSheetResult
    data class OnDueDateSelect(val dueDate: String) : BandalartBottomSheetResult
    data class OnTitleUpdate(val title: String, val currentLocale: Locale) : BandalartBottomSheetResult
    data class OnDescriptionUpdate(val description: String) : BandalartBottomSheetResult
    data class OnCompletionUpdate(val isCompleted: Boolean) : BandalartBottomSheetResult
}
...
//    data class OnDeleteDialogConfirmClick(val id: Long) : Event
//    data object OnDeleteDialogCancelClick : Event
...
//    data class OnDueDateSelect(val dueDate: String) : Event
//    data class OnTitleUpdate(val title: String, val currentLocale: Locale) : Event
...
//                        navigator.finish(BandalartBottomSheetResult(isCellUpdated = true))
//                    }
//                    // ... 다른 이벤트 처리
//                }
//            }
